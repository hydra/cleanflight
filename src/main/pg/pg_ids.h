...
#define PG_MIXER_CONFIG 20 // mixerConfig_t and servoMixerConfig_t
#define PG_SERVO_MIXER 21 // single servoParam_t
#define PG_IMU_CONFIG 22 // imuRuntimeConfig_t with additional parameters
...
#define PG_MOTOR_3D_CONFIG 26 // flight3DConfig_t with more parameters
...
#define PG_RATE_PROFILE_SELECTION 36 // part of profile now
...
#define PG_PILOT_CONFIG 47 // no-longer exists
#define PG_MSP_SERVER_CONFIG 48 // no-longer exists
...
#define PG_DEBUG_CONFIG 51 // no-longer exists
...
#define PG_DRIVER_PWM_RX_CONFIG 100 // no-longer exists
#define PG_DRIVER_FLASHCHIP_CONFIG 101 // no-longer exists
